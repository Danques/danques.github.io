...
// Renders a shader material into a tiny offscreen target and averages the
// pixels to approximate the artwork's current dominant color.
...
// Adds a soft halo around the artwork plane plus a matching patch of light
// on the wall behind it, both tinted with the shader's sampled color, and a
// faint point light so nearby wall/floor geometry picks up the color too.
